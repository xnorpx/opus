...
function(opus_detect_sse COMPILER_SUPPORT_SIMD)
  ...
  check_include_file(immintrin.h HAVE_IMMINTRIN_H) # AVX_FMA_AVX2
  if(HAVE_IMMINTRIN_H)
    if(MSVC)
      check_flag(AVX_FMA_AVX2 /arch:AVX2)
    else()
      check_flag(AVX_FMA_AVX2 -mavx -mfma -mavx2)
    endif()
  else()
    set(AVX_FMA_AVX2_SUPPORTED
        0
        PARENT_SCOPE)
  endif()

  if(SSE1_SUPPORTED OR SSE2_SUPPORTED OR SSE4_1_SUPPORTED OR AVX_FMA_AVX2_SUPPORTED)
