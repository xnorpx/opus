...
if(HAVE_ALLOCA_H)
  ...
  check_symbol_exists(alloca "alloca.h" COMPILER_USE_ALLOCA_SUPPORTED)
else()
  check_symbol_exists(alloca "stdlib.h;malloc.h" COMPILER_USE_ALLOCA_SUPPORTED)
endif()
...
if(HAVE_LIBM)
  # we unset the requirements to silence warnings
...
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "(arm|aarch64)")
  ...
  message(ERROR ${CMAKE_SYSTEM_PROCESSOR} not supported in OPUS CMake)
endif()
...
if(MINGW)
  ...
  if(NOT HAVE_LIBSSP)
    ...
    set(COMPILER_STACK_PROTECTOR_FLAG_SUPPORTED 0)
