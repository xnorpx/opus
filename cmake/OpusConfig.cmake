...
if(CMAKE_SYSTEM_PROCESSOR MATCHES "(i[0-9]86|x86|X86|amd64|AMD64|x86_64)")
  if(CMAKE_SIZEOF_VOID_P EQUAL 8)
    message(STATUS "Opus Arch: x86_64")
    set(OPUS_CPU_X64 1 CACHE INTERNAL "")
  else()
    message(STATUS "Opus Arch: x86")
    set(OPUS_CPU_X86 1 CACHE INTERNAL "")
  endif()
elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "(arm|aarch64)")
  message(STATUS "Opus Arch: ARM")
  set(OPUS_CPU_ARM 1 CACHE INTERNAL "")
  if(CMAKE_SYSTEM_PROCESSOR MATCHES "aarch64")
    message(STATUS "Opus Arch: ARMv8")
    set(OPUS_CPU_ARM_V8 1 CACHE INTERNAL "")
  endif()
else()
  message(WARNING "Opus Arch: No intrinsics support")
endif()
